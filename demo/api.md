...
| [level](#level)       | `level`       | `number` |           | Determines the semantic heading level of the HTML element. Options are `1` - `6`. |
...
| [visualLevel](#visualLevel) | `visualLevel` | `number` | ""        | Determines the visual appearance of the header. Options are `1` - `6`. |
...
<div class="exampleWrapper">
  ...
  <table>
    ...
    <tr>
      ...
      <td>
        <auro-header visualLevel="1">Extra large display</auro-header>
      </td>
      <td>
    ...
    <tr>
      ...
      <td>
        <auro-header visualLevel="2">Large display</auro-header>
      </td>
      <td>
    ...
    <tr>
      ...
      <td>
        <auro-header visualLevel="6" typography="display">Extra small heading</auro-header>
      </td>
    </tr>
  </table>
  <!-- AURO-GENERATED-CONTENT:END -->
