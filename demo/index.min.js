...
class AuroHeader extends i$1 {
  ...
  static get properties() {
    return {
       ...
       * @default If `visualLevel` is not specified, `visualLevel` will defaults to the same value as `level`
       */
      visualLevel: {
        type: Number,
        reflect: true,
