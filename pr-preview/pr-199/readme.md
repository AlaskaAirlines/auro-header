...
[![Build Status](https://img.shields.io/github/actions/workflow/status/AlaskaAirlines/auro-header/release.yml?style=for-the-badge)](https://github.com/AlaskaAirlines/auro-header/actions/workflows/release.yml)
...
<pre class="language-shell"><code class="language-shell">$ npm i @aurodesignsystem/auro-header</code></pre>
...
<pre class="language-js"><code class="language-js">import "@aurodesignsystem/auro-header";</code></pre>
...
<pre class="language-html"><code class="language-html">&lt;script type="module" src="https://cdn.jsdelivr.net/npm/@aurodesignsystem/auro-header@latest/+esm"&gt;&lt;/script&gt;</code></pre>
...
AuroHeader.register('custom-header');</code></pre>
...
<pre class="language-html"><code class="language-html">&lt;custom-header&gt;Hello World!&lt;/custom-header&gt;</code></pre>
<!-- AURO-GENERATED-CONTENT:END -->
</auro-accordion>
